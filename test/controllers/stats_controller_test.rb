...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { dose_size: @stat.dose_size, poison_id: @stat.poison_id, user_id: @stat.user_id } }, as: :json
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { dose_size: @stat.dose_size, poison_id: @stat.poison_id, user_id: @stat.user_id } }, as: :json
    assert_response 200
  end
